      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          {credibility.map((c) => (
            <div
              key={c.label}
              className="group relative p-6 rounded-2xl border border-border bg-white hover:border-gold/60 hover:shadow-elevated transition-all duration-300 ease-out"
            >
...
export function Footer() {
  return (
    <footer id="contato" className="relative bg-navy-deep text-platinum overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-10 py-16 lg:py-20 grid lg:grid-cols-12 gap-10 lg:gap-12">
